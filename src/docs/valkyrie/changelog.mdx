...
**Date of release (V1.5.0)**: 18/03/21 GTM -6
...
- **Fixed**: CSS/ JS files are now better organized a readable.
- **Fixed**: Minor Bugs.
...
- **Enhanced**: The design of the subscribe form.
...
- **Fixed**: Linear gradient on Google Chrome left 1 pixel to cover on post previews, resulting in a undesired look.
